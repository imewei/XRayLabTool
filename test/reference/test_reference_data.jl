...
function test_reference_data()
    ...
    for material in materials
        ...
        try
            ...
            println("    - Energy range: $(minimum(data_json["energy_keV"])) - $(maximum(data_json["energy_keV"])) keV")
            ...
            println("    - Energy range: $(minimum(data_csv["energy_keV"])) - $(maximum(data_csv["energy_keV"])) keV")
